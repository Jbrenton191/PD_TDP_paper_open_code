...
# Updated to keep Control as baseline - wasn't run like this but should be other way around - it should be group of interest vs control (same as numerator/demoninator)
meta$group=droplevels(factor(meta$group, levels = c("Control", "PD")))
